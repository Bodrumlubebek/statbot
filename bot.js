...
app.get("/", (request, response) => {
  console.log('İzexLesh StatsBot 7/24 Çalışıyor!');
...
client.on("ready", () => {
    console.log("Bot Artık Aktif... Düzgün Bir Şekilde Çalıştırılıyor...");
});

client.on("ready", async function() {
const voiceChannel = ""(ses kanal id girin botunuz sese girsin)
...
client.login(ayarlar.token); //client.login(process.env.TOKEN) yaparsanız tokeni env gizliyebilirsiniz.
